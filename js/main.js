...
// Se ejecuta solo cuando el DOM esté completamente cargado
document.addEventListener("DOMContentLoaded", () => {
  ...
  // === 5. Solo ejecutar MQTT en mqtt.html ===
  if (window.location.pathname.includes("mqtt.html")) {
    ...
    if (typeof mqtt === 'undefined') {
      console.error("❌ ERROR: mqtt.js no se ha cargado. Verifica la ruta o conexión.");
      return;
    }
    ...
    // === Elementos del DOM para mostrar datos ===
    const elements = {};
